  ...
  BOOST_AUTO_TEST_SUITE(tap_)
    ...
    BOOST_AUTO_TEST_SUITE(traverser_)
      ...
      BOOST_AUTO_TEST_SUITE(fake)
        ...
        BOOST_AUTO_TEST_CASE(min_messaging_event_mobile_session)
        {
          using namespace xfsx::tap::traverser;
          using namespace grammar::tap;
          Fake_Proxy p;
          Fake_Proxy::Tags t = {
            ...
            make_tuple(Tag::SERVICE_START_TIME_STAMP, string(), 4 ),
            make_tuple(Tag::LOCAL_TIME_STAMP, string("20160310192323"), 5 ),
            make_tuple(Tag::UTC_TIME_OFFSET_CODE, string("1"), 5 ),
            make_tuple(23, string(), 3),
        ...
        BOOST_AUTO_TEST_CASE(tax_multi)
        {
          using namespace xfsx::tap::traverser;
          using namespace grammar::tap;
          Fake_Proxy p;
          Fake_Proxy::Tags t = {
            ...
            make_tuple(23, string(), 2),
            make_tuple(Tag::CHARGE_TYPE, "00", 5),
            make_tuple(Tag::CHARGE, "15", 5),
            make_tuple(Tag::CHARGE_TYPE, "01", 5),
            make_tuple(Tag::CHARGE, "15", 5),
            make_tuple(Tag::TAX_VALUE, string("20"), 4),
            make_tuple(Tag::TAX_VALUE, string("30"), 4),
