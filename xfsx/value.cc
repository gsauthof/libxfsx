...
Value::Value(Value &&o)
{
  switch(o.tag_) {
    ...
    case 10:
      ...
      break;
    case 11:
      new (&std_pair_const_u8_const_u8__) std::pair<const u8*, const u8*>(std::move(o.std_pair_const_u8_const_u8__));
      tag_ = 11;
      break;
    case 12:
...
void Value::destruct()
{
  switch(tag_) {
    ...
    case 11: std_pair_const_u8_const_u8__.~pair<const u8*, const u8*>(); break;
...
Value &Value::operator=(Value &&o)
{
  switch(o.tag_) {
    ...
    case 11:
      if (tag_ == o.tag_) {
        std_pair_const_u8_const_u8__ = std::move(o.std_pair_const_u8_const_u8__);
      } else {
        destruct();
        new (&std_pair_const_u8_const_u8__) std::pair<const u8*, const u8*>(std::move(o.std_pair_const_u8_const_u8__));
        tag_ = 11;
...
Value::Value(std::pair<const u8*, const u8*> &&o)
  : std_pair_const_u8_const_u8__(std::move(o))
{
  tag_ = 11;
}
...
Value &Value::operator=(std::pair<const u8*, const u8*> &&o)
{
  if (tag_ == 11) {
    std_pair_const_u8_const_u8__ = std::move(o);
  } else {
    destruct();
    new (&std_pair_const_u8_const_u8__) std::pair<const u8*, const u8*>(std::move(o));
    tag_ = 11;
  }
  return *this;
}
